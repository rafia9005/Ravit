  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        const errorMsg = err instanceof Error ? err.message : "Terjadi kesalahan saat memproses login";
        setError(errorMsg);
          ...
          <Card className="border-zinc-200 shadow-lg dark:border-zinc-800">
            <CardHeader className="space-y-2 pb-4 text-center">
              ...
              <CardDescription className="text-center">
                Terjadi kesalahan saat memproses OAuth callback
              </CardDescription>
            </CardHeader>
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-zinc-50 px-4 dark:bg-zinc-950 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        <Card className="border-zinc-200 shadow-lg dark:border-zinc-800">
          <CardHeader className="space-y-2 pb-4 text-center">
            <CardTitle className="text-2xl">Memproses Login</CardTitle>
            <CardDescription className="text-center">
